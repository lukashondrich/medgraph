...
_LIVEQA_TYPE_ROUTES: dict[str, list[str]] = {
    ...
    "TREATMENT": ["symptom", "medication", "evidence"],
    "EFFECT": ["symptom", "medication", "evidence"],
    "ALTERNATIVE": ["medication", "lifestyle"],
    "COMPARISON": ["medication"],
    "INFORMATION": ["evidence"],
    "INHERITANCE": ["evidence"],
    "PERSON_ORGANIZATION": ["evidence"],
    "OTHER_QUESTION": ["evidence"],
}
...
_MEDQA_TYPE_ROUTES: dict[str, list[str]] = {
    ...
    "Combination": ["medication", "drug_check"],
