"""Symptom triage specialist agent."""

from __future__ import annotations

from src.models.state import HealthcareState
from src.prompts.symptom import SYSTEM_PROMPT

from .base import HealthcareAgent


class SymptomAgent(HealthcareAgent):
    """Assesses symptoms and triages urgency."""

    def __init__(self, model: str | None = None) -> None:
        super().__init__(name="symptom", system_prompt=SYSTEM_PROMPT, model=model)
